...
function listenToInputEvents() {
  ...
  const selectLocationInputDom = document.querySelectorAll(
    'input[name="location"]'
  );
  const checkboxTermsAndConditionsInputDom =
...
function isFirstNameValid() {
  const errorFormDataFirstName =
    document.getElementById("firstName").parentNode;
  ...
  errorFormDataFirstName.setAttribute(
    "data-error-visible",
...
function lastnameIsValid() {
  ...
  errorFormDataLastName.setAttribute(
    "data-error-visible",
    errorMessage ? "true" : "false"
  );
}
...
function emailIsValid() {
  ...
  if (email === "") {
    ...
    errorMessage =
      "Veuillez entrer une adresse email valide. ex:john@gmail.com";
  }

  errorFormDataEmail.setAttribute("data-error", errorMessage);
  errorFormDataEmail.setAttribute(
    "data-error-visible",
    errorMessage ? "true" : "false"
  );
}
...
function birthDateIsValid() {
  ...
  errorFormDataBirthDate.setAttribute(
    "data-error-visible",
    errorMessage ? "true" : "false"
  );
}
...
function quantityIsValid() {
  const errorFormDataTournamentQuantity =
  ...
  if (
    !Number.isInteger(tournamentQuantityInt) ||
    !Number.isFinite(tournamentQuantityInt)
  ) {
    //booleen
    ...
    errorMessage =
      "Veuillez entrer un nombre entier pour la quantité de tournois.";
  } else {
  ...
  errorFormDataTournamentQuantity.setAttribute(
    "data-error-visible",
    errorMessage ? "true" : "false"
  );
}
...
function locationIsValid() {
  const errorFormDataLocation = document.querySelector(
    "input[name=location]"
  ).parentNode;
  //console.log(selectLocation);
  if (selectLocation === "") {
    errorFormDataLocation.setAttribute(
      "data-error",
...
function termsAndConditionsAreChecked() {
  ...
  errorCheckedConditions.setAttribute(
    "data-error",
    checkbox.checked ? "" : errorMessage
  );
  errorCheckedConditions.setAttribute(
    "data-error-visible",
    errorMessage ? "true" : "false"
...
buttonCloseModal.addEventListener(
  "click",
  () => closeModalFormAndThanksModal(true) && closeModalForm
);

//Fonction pour fermer la modal au boutton X
function closeModalFormAndThanksModal(shouldResetFormValue = false) {
  ...
  // fais disparaitres la modal au clic du boutton X (.close)
